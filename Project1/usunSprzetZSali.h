...
namespace Project1 {
	...
	/// <summary>
	/// Podsumowanie informacji o usunSprzetZSali
	/// </summary>
	public ref class usunSprzetZSali : public System::Windows::Forms::Form
	{
	public:
		usunSprzetZSali(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &usunSprzetZSali::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &usunSprzetZSali::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &usunSprzetZSali::button3_Click);
			// 
			// Nazwa
			// 
			...
			this->Name = L"usunSprzetZSali";
			this->Text = L"Usun Sprzet Z Sali";
...
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	u->usunSprzetZSali(nazwasali, nazwasprzetu);
	MessageBox::Show("Usuniêto sprzêt z sali");
}
	};
}
