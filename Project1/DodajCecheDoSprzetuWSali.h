...
namespace Project1 {
	...
	/// <summary>
	/// Podsumowanie informacji o DodajCecheDoSprzetuWSali
	/// </summary>
	public ref class DodajCecheDoSprzetuWSali : public System::Windows::Forms::Form
	{
	public:
		DodajCecheDoSprzetuWSali(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &DodajCecheDoSprzetuWSali::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DodajCecheDoSprzetuWSali::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DodajCecheDoSprzetuWSali::button3_Click);
			// 
			// Nazwa
			// 
			...
			this->label3->Text = L"Cecha sprzêtu:";
			// 
			// DodajCecheDoSprzetuWSali
			// 
			...
			this->Name = L"DodajCecheDoSprzetuWSali";
			this->Text = L"Dodaj Ceche Do Sprzetu W Sali";
...
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	u->dodajCecheDoSprzetuWSali(nazwasali, nazwasprzetu, nazwacechy);
	MessageBox::Show("Dodano cechê do sprzêtu w sali");
}
	};
}
